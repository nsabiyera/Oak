...
namespace Oak.Controllers
{
    ...
    public class Schema
    {
        ...
        {
            yield return CreateTodosTable;
        }

        public string CreateTodosTable()
        {
            return Seed.CreateTable("Todos",
                Seed.GuidId(),
                new { Content = "nvarchar(1500)" },
                new { Done = "bit" },
                new { Order = "int" });
        }
        ...
        {
            new { Id = Guid.NewGuid(), Content = "finish todo app", Done = false }.InsertInto("Todos");

            new { Id = Guid.NewGuid(), Content = "finish iphone app", Done = false }.InsertInto("Todos");
        }
