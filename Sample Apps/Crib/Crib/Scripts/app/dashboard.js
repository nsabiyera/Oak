...
(function() {
  ...
  BenchView = Backbone.View.extend({
    ...
    render: function() {
      ...
      return this.bench.each((function(_this) {
        return function(consultant) {
          var view;
  ...
  RollOffsView = Backbone.View.extend({
    ...
    render: function() {
      ...
      return this.rollOffs.each((function(_this) {
        return function(consultant) {
  ...
  ConsultantView = Backbone.View.extend({
    ...
    engageConsultant: '<a class="thumbnail"> <img src="${imageUrl}" alt="" width="130px" height="90px"> </a> <div class="well" style="margin: 3px; padding: 3px; width: 130px"> <div class="btn-group"> <a class="btn dropdown-toggle" style="width: 110px" data-toggle="dropdown" href="javascript:;"> Options <span class="caret"></span> </a> <ul class="dropdown-menu"> <li><a href="javascript:;" class="extend">consultant has been extended</li> <li><a href="javascript:;" class="edit">edit</a></li> </ul> </div> <h4 style="margin: 5px">${name}</h4> </div>',
    benchConsultant: '<a class="thumbnail"> <img src="${imageUrl}" alt="" width="130px" height="90px"> </a> <div class="well" style="margin: 3px; padding: 3px; width: 130px"> <div class="btn-group"> <a class="btn dropdown-toggle" style="width: 110px" data-toggle="dropdown" href="javascript:;"> Options <span class="caret"></span> </a> <ul class="dropdown-menu"> <li><a href="javascript:;" class="edit">edit</a></li> </ul> </div> <h4 style="margin: 5px">${name}</h4> </div>'
  });
  ...
  EditConsultantModal = new (Backbone.View.extend({
    render: function() {
      ...
      $(this.el).find("#updateConsultant").click((function(_this) {
        return function() {
  ...
  NewConsultantModal = new (Backbone.View.extend({
    render: function() {
      ...
      $(this.el).find("#createConsultant").click((function(_this) {
        return function() {
  ...
  ExtendConsultantModal = new (Backbone.View.extend({
    ...
    render: function() {
      ...
      view = $(this.el);
      $(this.el).find("#extendConsultant").click((function(_this) {
        return function() {
          _this.save();
