...
task :regen_db => :build do
  sh regen_db_command("data source=#{ @database_server };Initial Catalog=#{ @database_name };Integrated Security=true")

  sh regen_db_command("data source=#{ @database_server };Initial Catalog=#{ @test_database_name };Integrated Security=true")
end
