...
(function() {
  ...
  unwantedGame = Backbone.Model.extend({
    ...
    undo: function(callback) {
      return $.post(this.get("undoNotInterested"), {}, (function(_this) {
        return function() {
  ...
  unwantedGamesView = Backbone.View.extend({
    ...
    render: function() {
      $(this.el).empty();
      this.unwantedGames.each((function(_this) {
  ...
  unwantedGameView = Backbone.View.extend({
    ...
    gameTemplate: '<td class="span1"> <span class="label label-important">quarantined</span> </td> <td>${gameName}</td> <td class="span1"><i class="icon-arrow-up cancel" style="cursor: pointer"></i></td>'
  });
