...
(function() {
  ...
  requestedGame = Backbone.Model.extend({
    ...
    giveGame: function(callback) {
      return $.post(this.get("giveGame"), {}, (function(_this) {
        return function() {
    ...
    gameReturned: function(callback) {
      return $.post(this.get("gameReturned"), {}, (function(_this) {
        return function() {
          requested.getRequestedGames();
          return callback();
        };
  ...
  requestedGamesView = Backbone.View.extend({
    ...
    render: function() {
      ...
      return this.requestedGames.each((function(_this) {
  ...
  requestedGameView = Backbone.View.extend({
    ...
    returnGameTemplate: '<td>${requestedBy} is currently <span class="label label-success">borrowing</span> ${gameName} - ${daysOut}</td> <td class="span2"> <i class="cancel icon-ok" style="cursor: pointer" href="javascript:;"></i> </td>',
    canGiveGameTemplate: '<td>${requestedBy} is <span class="label label-inverse">requesting</span> ${gameName}</td> <td class="span2"> <i class="check icon-share-alt" style="cursor: pointer" href="javascript:;"></i> </td>'
  });
