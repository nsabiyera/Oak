...
(function() {
  ...
  wantedGame = Backbone.Model.extend({
    ...
    undoRequest: function(callback) {
      return $.post(this.get("deleteWant"), {}, (function(_this) {
        return function() {
    ...
    returnGame: function(callback) {
      return $.post(this.get("returnGame"), {}, (function(_this) {
        return function() {
          preferred.getPreferredGames();
          _this.change();
          return callback();
  ...
  wantedGamesView = Backbone.View.extend({
    ...
    render: function() {
      $(this.el).empty();
      return this.wantedGames.each((function(_this) {
  ...
  wantedGameView = Backbone.View.extend({
    ...
    borrowedGameTemplate: '<td class="span1"> <span class="label label-success">currently borrowing</span> <span class="label ${daysLeftClass}">${daysLeft}</span> </td> <td>${gameName}</td> <td>${owner}</td> <td class="span2"><i class="icon-remove cancel" style="cursor: pointer"></i></td>',
    requestedGameTemplate: '<td class="span1"> <span class="label label-inverse">requested</span> </td> <td>${gameName}</td> <td>${owner}</td> <td class="span2"><i class="icon-remove cancel" style="cursor: pointer">&nbsp;</i></td>'
  });
